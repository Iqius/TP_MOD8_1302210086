...
namespace TP_MOD8_1302210086
{
    internal class CovidConfig
    {
        ...
        {
            config = new Config("celcius", 86, "Anda tidak diperbolehkan masuk ke dalam gedung ini", "Anda dipersilahkan untuk masuk ke dalam gedung ini");
        }
